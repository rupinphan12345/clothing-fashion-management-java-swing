...
public class SanPham {
    ...
    public SanPham(String maSanPham, LoaiSanPham loaiSanPham, NhaCungCap nhaCungCap, String tenSanPham, double gia, int soLuong, List<String> danhSachKichCo, String thuongHieu, List<String> danhSachMauSac, String hinhAnh) {
        setMaSanPham(maSanPham);
