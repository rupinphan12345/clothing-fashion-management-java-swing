...
public class HoaDon {
    ...
    public HoaDon(String maHoaDon, KhachHang khachHang, NhanVien nhanVien, Date ngayTao, double giamGia, List<ChiTietHoaDon> danhSachChiTietHoaDon) throws Exception {
        setMaHoaDon(maHoaDon);
